  ...
  apps: [
    {
      ...
      env: {
        ...
        PORT: "5000",
        SOCKET_SERVER_URL: "https://socket.officeportal.vtabsquare.com",
        FRONTEND_BASE_URL: "https://officeportal.vtabsquare.com",
        GOOGLE_REDIRECT_URI: "https://api.officeportal.vtabsquare.com/google/oauth2callback",
      },
    ...
    },
    {
      ...
      env: {
        PORT: "4001",
        NODE_ENV: "production",
        SOCKET_ORIGINS: "https://officeportal.vtabsquare.com,https://api.officeportal.vtabsquare.com",
